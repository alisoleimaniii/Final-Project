...
(function(factory) {
    ...
    var Comments = {
        ...
        events: {
            ...
            'click .commenting-field .delete.enabled.btn.btn-radius': 'deleteComment',
            'change .commenting-field .upload.enabled input[type="file"]': 'fileInputChanged',

            // Other actions
            'click li.comment button.upvote': 'upvoteComment',
            'click li.comment button.delete.enabled.btn.btn-radius': 'deleteComment',
        ...
        getDefaultOptions: function() {
            return {
                ...
                textareaPlaceholderText: 'دیدگاه خود را بنویسید',
                newestText: 'Newest',
                oldestText: 'Oldest',
                popularText: 'Popular',
                attachmentsText: 'آپلود فایل',
                sendText: 'ارسال',
                replyText: 'ارسال پاسخ',
                editText: 'ویرایش',
                editedText: 'ویرایش شده',
                youText: 'نظر شما',
                saveText: 'ذخیره',
                deleteText: 'پاک کردن',
                newText: 'جدید',
                viewAllRepliesText: 'نظرات __replyCount__ مشاهده همه',
                hideRepliesText: 'مخفی کردن نظرات',
                noCommentsText: 'اولین نفری باشید که نظر میدهد',
                noAttachmentsText: 'بدون هیچ فایلی',
                attachmentDropText: 'فایل های خود را در اینجا رها کنید',
        ...
        putComment: function(ev) {
            ...
            $.extend(commentJSON, {
                ...
                modified: new JDate().getTime().toLocaleString()
            });
        ...
        createProfilePictureElement: function(src) {
            if (src) {
                ...
                var profilePicture = $('<i/>', {
                    'class': 'fa icon-user profile-picture'
                });
            }
        ...
        createCommentingFieldElement: function(parentId, existingCommentId) {
            ...
            var saveButton = $('<span/>', {
                'class': saveButtonClass + ' save btn btn-radius btn-yellow',
                text: saveButtonText
            });
        ...
        createCommentWrapperElement: function(commentModel) {
            ...
            if (commentModel.isNew) {
                var newTag = $('<span/>', {
                    'class': 'new btn btn-radius btn-yellow',
            ...
            if (commentModel.createdByCurrentUser || this.options.currentUserIsAdmin) {
                ...
                if (isAttachment && this.isAllowedToDelete(commentModel.id)) {
                    var deleteButton = $('<button/>', {
                        'class': 'action delete enabled btn btn-radius',
                        text: this.options.textFormatter(this.options.deleteText)
                    });
        ...
        createCssDeclarations: function() {
            ...
            this.createCss('.jquery-comments .btn btn-radius btn-yellow {background: ' +
                this.options.highlightColor + ' !important;', +'}');
        ...
        createCommentJSON: function(textarea) {
            var time = new JDate().toLocaleString();
            var commentJSON = {
